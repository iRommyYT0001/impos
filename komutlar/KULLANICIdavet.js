...
exports.run = (client, message) => {
  ...
  .setColor("GOLD")
    .addField("» **Botun Sahibi**", "<@!822437690615267358> | <@!751377560713166918>")
    .addField("**» Destek Sunucusu**", " [Sunucumuza Katıl](https://discord.gg/xksdUskx8q)", )
    .addField("**» Davet Linki**", " [Botu Davet Et](https://discord.com/api/oauth2/authorize?client_id=829433750458204230&permissions=8&scope=bot)", )
	.addField("**» Oy Linki**", " [Yakında]()", )
   .addField("**» Web Sitesi**", " [Web Sitesini Ziyaret Etl](https://kobot-website.glitch.me/)", )
