...
exports.run = (client, message, params) => {
  ...
  .setTitle("KoBot Eğlence Menüsü")
  .setColor("RANDOM")
  .addField("**.efkarım**", "** <:KoBot_Nokta:829421964044402758>`Efkarınızı Ölçer.`**",)
  .addField("**.aykut-elmas**", "** <:KoBot_Nokta:829421964044402758> `Classic Aykut Elmas Sözleri.`**",)
  .addField("**.kaç-cm**", "** <:KoBot_Nokta:829421964044402758>`Malafatını Ölçer.`**",)
  .addField("**.trump**", "** <:KoBot_Nokta:829421964044402758> `Trump Tweet Atar.`**",)
  .addField("**.atam**", "** <:KoBot_Nokta:829421964044402758> `Dene ve Gör Reis.`**",)
  .addField("**.vine**", "** <:KoBot_Nokta:829421964044402758> `Komik Paylaşımlar.`**",)
